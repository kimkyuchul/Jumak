...
final class WriteEpisodeViewModel: ViewModelType, Coordinatable {
    ...
    func transform(input: Input) -> Output {
        ...
        input.didSelectWriteButton
            ...
            .withUnretained(self)
            .flatMap { owner, episodeTable in
                owner.writeEpisodeUseCase
                    .updateEpisodeList(owner.storeVO, episode: episodeTable.toDomain(), imageData: owner.imageData)
